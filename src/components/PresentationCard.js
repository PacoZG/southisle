      ...
      <div className="container-2">
        ...
        <div className="column2">
          ...
          <h4 className="h4" style={{ padding: "11px" }}>
            ...
            and ﬂoor manager duties, my responsibilities were also as following:
          </h4>
          <h3 className="h3" style={{ fontSize: "16px" }}>
          ...
          <ul className="ul-work">
            ...
            <li className="li">Training, Introduction material and -process</li>
          ...
          <h3 className="h3" style={{ fontSize: "16px" }}>
            Head Waiter/Event Coordinator Palace <br /> Kämp Ravintolat Oy/Royal
            Ravintolat Oy
          </h3>
